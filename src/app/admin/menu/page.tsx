    ...
    <div className="p-4 md:p-8 max-w-7xl mx-auto text-white h-[calc(100vh-64px)] md:h-screen flex flex-col">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6 md:mb-8">
        ...
        <button 
          ...
          className="w-full md:w-auto bg-crack-orange hover:bg-[#c96d53] text-white px-6 py-3 rounded-xl font-bold flex items-center justify-center gap-2 transition-all shadow-lg shadow-crack-orange/20"
        >
